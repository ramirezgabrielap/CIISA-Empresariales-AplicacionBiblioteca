...
public class NewServletDeleteEditorial extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        int id_editorial = Integer.parseInt(request.getParameter("ideditorial"));
        String mensaje="";
        
        CrudEditorial cs = new CrudEditorial();
        CrudLibro cl = new CrudLibro();
        
        List<DAOLibro> libros = cl.Read_Search_IDEditorial(id_editorial);
        ...
        mensaje += cs.Delete(id_editorial);
